...
let Board = function (canvasId) {
  ...
  this.assignCornersToTiles();
  this.assignBordersToTiles();
...
Board.prototype.getAllCorners = function () {
  var all = [];
...
Board.prototype.getAllBorders = function () {
  var all = [];
  this.tiles.forEach(tile => {
...
Board.prototype.getNeighborsCorner = function (tile, direction) {
...
Board.prototype.getNeighborsBorder = function (tile, direction) {
...
Board.prototype.assignCornersToTiles = function () {
  this.tiles.forEach(tile => {
    Object.keys(tile.corners).forEach(direction => {
      var corner = this.getNeighborsCorner(tile, direction) || 
...
Board.prototype.assignCornersToBorder = function (tile, direction) {
...
Board.prototype.assignBordersToTiles = function () {
  this.tiles.forEach(tile => {
    Object.keys(tile.borders).forEach(direction => {
      var border = this.getNeighborsBorder(tile, direction) ||
                   tile.makeBorder(direction);

      border.tiles.push(tile);
      tile.borders[direction] = border;
      this.assignCornersToBorder(tile, direction);
    });
  });
};
